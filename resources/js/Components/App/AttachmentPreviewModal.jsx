...
import {isAudio, isImage, isPDF, isPreviewable, isVideo} from "@/helpers.js";
import {Dialog, Transition} from "@headlessui/react";
import {ChevronLeftIcon, ChevronRightIcon, PaperClipIcon, XMarkIcon} from "@heroicons/react/24/solid/index.js";
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="h-screen w-screen">
                        <Transition.Child
                            ...
                            >
                            <Dialog.Panel
                                className="flex flex-col w-full h-full transform overflow-hidden bg-gray-300 text-left align-middle shadow-xl transition-all"
                            >
                                <button
                                    onClick={close}
                                    className="absolute right-3 top-3 w-10 h-10 rounded-full hover:bg-gray-400 transition flex items-center justify-center text-black-400 z-40"
                                >
