...
import {formatBytes, isPDF, isPreviewable} from "@/helpers.js";
...
const AttachmentPreview = ({ file }) => {
    return (
        <div className="w-full flex items-center gap-2 py-2 px-3 rounded-md bg-gray-300">
            <div>
                {isPDF(file.file) && <img src="/images/pdf.png" alt="pdf" className="w-8 h-8" />}
            ...
            <div className="flex-1 text-black-400 text-nowrap text-ellipsis overflow-hidden">
